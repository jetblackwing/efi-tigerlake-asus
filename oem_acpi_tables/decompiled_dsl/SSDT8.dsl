...
DefinitionBlock ("", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    External (_SB_.PC00.LPCB.EC0_.BDIN, UnknownObj)
    External (_SB_.PC00.LPCB.EC0_.BOTP, UnknownObj)
    External (_SB_.PC00.LPCB.EC0_.BRAH, UnknownObj)
    External (_SB_.PC00.LPCB.EC0_.CNTB, UnknownObj)
    External (_SB_.PC00.LPCB.EC0_.CNTD, UnknownObj)
    External (_SB_.PC00.LPCB.EC0_.ST8E, MethodObj)    // 2 Arguments
    External (_SB_.PC00.LPCB.EC0_.ST9E, MethodObj)    // 3 Arguments
    External (_SB_.PC00.LPCB.EC0_.STCC, MethodObj)    // 2 Arguments
    External (_SB_.PC00.LPCB.H_EC.LTMP, UnknownObj)
    External (_SB_.PC00.PEG0, DeviceObj)
    External (_SB_.PC00.PEG0.CEDR, UnknownObj)
    External (_SB_.PC00.PEG0.DGCX, IntObj)
    External (_SB_.PC00.PEG0.HGMD, UnknownObj)
    External (_SB_.PC00.PEG0.LKND, UnknownObj)
    External (_SB_.PC00.PEG0.LKNS, UnknownObj)
    External (_SB_.PC00.PEG0.LREN, UnknownObj)
    External (_SB_.PC00.PEG0.PEGP, DeviceObj)
    External (_SB_.PC00.PEG0.PEGP._ADR, DeviceObj)
    External (_SB_.PC00.PEG0.TDGC, IntObj)
    External (_SB_.PC00.PEG0.TGPC, IntObj)
    ...
    OperationRegion (TPNV, SystemMemory, 0x720FE000, 0x0036)
    ...
    Scope (\_SB.PC00.PEG0)
    {
        OperationRegion (RPCX, SystemMemory, ((\XBAS + 0x00030000) + Zero), 0x1000)
        ...
        PowerResource (PG00, 0x00, 0x0000)
        {
            ...
            {
                If ((\_SB.PC00.PEG0.TDGC == One))
                {
                    If ((\_SB.PC00.PEG0.DGCX == 0x03))
                    {
                        \_SB.PC00.PEG0.PEGP.GC6O ()
                    }
                    ElseIf ((\_SB.PC00.PEG0.DGCX == 0x04))
                    {
                        \_SB.PC00.PEG0.PEGP.GC6O ()
                    }

                    \_SB.PC00.PEG0.TDGC = Zero
                    \_SB.PC00.PEG0.DGCX = Zero
                    _STA = One
                }
                Else
                {
                    If ((OSYS > 0x07D9))
                    {
                        ...
                        CMDR |= 0x06
                        D0ST = Zero
                        If ((\_SB.PC00.PEG0.PEGP.VEID == 0x10DE))
                        {
                            \_SB.PC00.PEG0.PEGP.NVID = HYSS /* \HYSS */
                            If ((NVAF == One))
                            {
                                \_SB.PC00.PEG0.PEGP.NHDA = One
                            }
                            Else
                            {
                                \_SB.PC00.PEG0.PEGP.NHDA = Zero
                            }
                        }

                        If ((\_SB.PC00.PEG0.PEGP.VEID == 0x1002))
                        {
                            \_SB.PC00.PEG0.PEGP.ATID = HYSS /* \HYSS */
                        }
                    ...
                    If ((\ODV0 == One))
                    {
                        \_SB.PC00.LPCB.EC0.CNTD |= 0x40
                    }
                    ElseIf ((\ODV0 == 0x02))
                    {
                        \_SB.PC00.LPCB.EC0.CNTD |= 0x20
                    }
                    Else
                    {
                        \_SB.PC00.LPCB.EC0.CNTD |= 0x80
                    }
            ...
            Method (_OFF, 0, Serialized)  // _OFF: Power Off
            {
                Sleep (0x0A)
                \_SB.PC00.LPCB.EC0.BRAH = 0xC9
                If (((\_SB.PC00.LPCB.EC0.BOTP == Zero) && (\_SB.PC00.LPCB.EC0.CNTB == Zero)))
                {
                    If (((\_SB.PC00.LPCB.EC0.CNTD & 0x07) != Zero))
                    {
                        Notify (\_SB.PC00.PEG0.PEGP, 0xD1) // Hardware-Specific
                    }
                }

                \_SB.PC00.LPCB.EC0.CNTD &= 0x18
                If ((\_SB.PC00.PEG0.TDGC == One))
                {
                    CreateField (\_SB.PC00.PEG0.TGPC, Zero, 0x03, GPPC)
                    If ((ToInteger (GPPC) == One))
                    {
                        \_SB.PC00.PEG0.PEGP.GC6I ()
                    }
    ...
    Scope (\_SB.PC00.PEG0.PEGP)
    {
        ...
        Method (SGST, 0, Serialized)
        {
            ...
            If ((\_SB.PC00.PEG0.PEGP.VEID != 0xFFFF))
            {
                Return (0x0F)
            }
        ...
        Method (_ROM, 2, NotSerialized)  // _ROM: Read-Only Memory
        {
            ...
            If ((Local0 < 0x8000))
            {
                ROM1 = RBF1 /* \_SB_.PC00.PEG0.PEGP.RBF1 */
            }
            ElseIf ((Local0 < 0x00010000))
            {
                Local0 -= 0x8000
                ROM1 = RBF2 /* \_SB_.PC00.PEG0.PEGP.RBF2 */
            }
            ElseIf ((Local0 < 0x00018000))
            {
                Local0 -= 0x00010000
                ROM1 = RBF3 /* \_SB_.PC00.PEG0.PEGP.RBF3 */
            }
            ElseIf ((Local0 < 0x00020000))
            {
                Local0 -= 0x00018000
                ROM1 = RBF4 /* \_SB_.PC00.PEG0.PEGP.RBF4 */
            }
            ElseIf ((Local0 < 0x00028000))
            {
                Local0 -= 0x00020000
                ROM1 = RBF5 /* \_SB_.PC00.PEG0.PEGP.RBF5 */
            }
            ElseIf ((Local0 < 0x00030000))
            {
                Local0 -= 0x00028000
                ROM1 = RBF6 /* \_SB_.PC00.PEG0.PEGP.RBF6 */
            }

            Local2 = (Local0 * 0x08)
            CreateField (ROM1, Local2, Local3, TMPB)
            ROM2 = TMPB /* \_SB_.PC00.PEG0.PEGP._ROM.TMPB */
            Return (ROM2) /* \_SB_.PC00.PEG0.PEGP._ROM.ROM2 */
        }
        ...
        Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
        {
            ...
            Return (\_SB.PC00.GFX0.HDSM (Arg0, Arg1, Arg2, Arg3))
        }
        ...
        Method (_ON, 0, Serialized)  // _ON_: Power On
        {
            ...
            If ((GPRF != One))
            {
                Local0 = CMDR /* \_SB_.PC00.PEG0.PEGP.CMDR */
                CMDR = Zero
    ...
    Scope (\_SB.PC00.GFX0)
    {
        ...
        Method (HDSM, 4, Serialized)
        {
            ...
            {
                Return (\_SB.PC00.PEG0.PEGP.NGC6 (Arg0, Arg1, Arg2, Arg3))
            }
            ...
            If ((OPCI || (SGCI || NBCI)))
            {
                ...
                If ((Arg2 == One))
                {
                    ...
                    Return (TEMP) /* \_SB_.PC00.GFX0.HDSM.TEMP */
                }
                ...
                If ((Arg2 == 0x02))
                {
                    ...
                    Else
                    {
                        ...
                        If ((GPPO == One))
                        {
                            Local0 = GPSS /* \_SB_.PC00.GFX0.GPSS */
                            Local0 |= 0x10
                            GPPO = Zero
                        }
                    }
                    ...
                    STS1 |= Local0
                    Return (TMP1) /* \_SB_.PC00.GFX0.HDSM.TMP1 */
                }
                ...
                If ((Arg2 == 0x03))
                {
                    ...
                    If ((\_SB.PC00.PEG0.PEGP.SGST () == 0x0F))
                    {
                        STS2 |= One
                    }

                    Return (TMP2) /* \_SB_.PC00.GFX0.HDSM.TMP2 */
                }
                ...
                If ((Arg2 == 0x04))
                {
                    ...
                    If ((Local1 != GPSP))
                    {
                        ...
                        Else
                        {
                            Local1 = GPSP /* \_SB_.PC00.GFX0.GPSP */
                            STS3 |= 0x8000
                        }
                    }

                    STS3 |= (Local1 << 0x0D)
                    Return (TMP3) /* \_SB_.PC00.GFX0.HDSM.TMP3 */
                }
                ...
                If ((Arg2 == 0x05))
                {
                    ...
                    STS4 |= (DKST << 0x05)
                    STS4 |= (LDES << 0x04)
                    STS4 |= DACE /* \_SB_.PC00.GFX0.DACE */
                    LDES = Zero
                    DHPS = Zero
                    DHPE = Zero
                    DACE = Zero
                    Return (TMP4) /* \_SB_.PC00.GFX0.HDSM.TMP4 */
                }

                If ((Arg2 == 0x06))
                {
                    Return (TLPK) /* \_SB_.PC00.GFX0.TLPK */
                }
                ...
                If ((Arg2 == 0x10))
                {
                    ...
                    If ((USRG == 0x564B))
                    {
                        Return (OPVK) /* \_SB_.PC00.GFX0.HDSM.OPVK */
                    }

                    If ((USRG == 0x4452))
                    {
                        Return (OPDR) /* \_SB_.PC00.GFX0.HDSM.OPDR */
                    }
                ...
                If ((Arg2 == 0x1A))
                {
                    ...
                    If (ToInteger (FLCH))
                    {
                        \_SB.PC00.PEG0.PEGP.OPCE = OMPR /* \_SB_.PC00.GFX0.HDSM.OMPR */
                    }
                    ...
                    If (ToInteger (DVSC))
                    {
                        If (ToInteger (DVSR))
                        {
                            \_SB.PC00.PEG0.PEGP.GPRF = One
                        }
                        Else
                        {
                            \_SB.PC00.PEG0.PEGP.GPRF = Zero
                        }
                    }

                    SNSR = \_SB.PC00.PEG0.PEGP.GPRF
                    If ((\_SB.PC00.PEG0.PEGP.SGST () != Zero))
                    {
                        CGCS = 0x03
                    }
    ...
    Scope (\_SB.PC00.PEG0.PEGP)
    {
        ...
        Method (GC6O, 0, Serialized)
        {
            Debug = "<<< GC6O >>>"
            Sleep (0x0A)
            \_SB.PC00.PEG0.LKND = Zero
            If ((\_SB.GGIV (0x09000006) == One))
            {
                \_SB.PC00.SGPO (SGGP, Zero, 0x09000005, Zero, One)
                While ((\_SB.GGIV (0x09000006) != Zero))
                {
                    Sleep (One)
                }

                \_SB.PC00.SGPO (SGGP, Zero, 0x09000005, Zero, Zero)
            }

            While ((\_SB.PC00.PEG0.LKNS < 0x07))
            {
                Sleep (One)
            }
        ...
        Method (NGC6, 4, Serialized)
        {
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                Case (One)
                {
                    ...
                    JTRV = 0x0103
                    Return (JTB1) /* \_SB_.PC00.PEG0.PEGP.NGC6.JTB1 */
                }
                Case (0x02)
                {
                    Debug = "GPS fun 19"
                ...
                Case (0x03)
                {
                    ...
                    \_SB.PC00.PEG0.TGPC = Arg3
                    If (((ToInteger (GPPC) != Zero) || (ToInteger (DFGC
                        ) != Zero)))
                    {
                        \_SB.PC00.PEG0.TDGC = ToInteger (DFGC)
                        \_SB.PC00.PEG0.DGCX = ToInteger (GPCX)
                    }
                    ...
                    If ((ToInteger (DFGC) != Zero))
                    {
                        GPGS = One
                        GUPS = One
                        Return (JTB3) /* \_SB_.PC00.PEG0.PEGP.NGC6.JTB3 */
                    }
        ...
        Method (GPS, 4, Serialized)
        {
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                Case (0x13)
                {
                    ...
                    PSTE = One
                    If ((\_SB.PC00.LPCB.EC0.BDIN == Zero))
                    {
                        \_SB.PC00.LPCB.EC0.BDIN = One
                        Notify (\_SB.PC00.PEG0.PEGP, 0xD1) // Hardware-Specific
                        \_SB.PC00.LPCB.EC0.BRAH = 0xC9
                        \_SB.PC00.LPCB.EC0.CNTD &= 0x18
                        If ((\ODV0 == One))
                        ...
                        \_SB.PC00.LPCB.EC0.CNTB = Zero
                        \_SB.PC00.LPCB.EC0.BOTP = Zero
                        Local0 = (\_SB.PC00.LPCB.EC0.ST8E (0x3B, 0xFF) | 0x10)
                        \_SB.PC00.LPCB.EC0.ST9E (0x3B, 0xFF, Local0)
                    }
                ...
                Case (0x22)
                {
                    ...
                    \_SB.CPPC = PCAP /* \_SB_.PC00.PEG0.PEGP.GPS_.PCAP */
                    PNOT ()
                    PSAP = PCAP /* \_SB_.PC00.PEG0.PEGP.GPS_.PCAP */
                    Return (PCAP) /* \_SB_.PC00.PEG0.PEGP.GPS_.PCAP */
                }
                Case (0x23)
                {
                    Debug = "GPS fun 23"
                    Return (PSAP) /* \_SB_.PC00.PEG0.PEGP.PSAP */
                }
                Case (0x2A)
                {
                    Debug = "GPS fun 42"
                    ...
                    Switch (ToInteger (PSH0))
                    {
                        Case (Zero)
                        {
                            ...
                            {
                                RETN = 0x0200
                                RETN |= PSH0 /* \_SB_.PC00.PEG0.PEGP.GPS_.PSH0 */
                                PDTS = \_SB.PC00.LPCB.H_EC.LTMP /* External reference */
                            }
                        ...
                        {
                            RETN = 0x0102
                            TGPU = \_SB.PC00.LPCB.EC0.STCC (Zero, 0x27)
                            PDTS = Zero
                            SFAN = Zero
                            CPUE = Zero
                            SKNT = Zero
    ...
    Scope (\_SB.PC00)
    {
        Device (WMI2)
        {
            ...
            Method (WMOP, 3, NotSerialized)
            {
                ...
                If ((Arg1 == 0x02))
                {
                    If ((\_SB.PC00.PEG0.PEGP.DGPS == Zero))
                    {
                        Return (0x10)
                    }
                    Else
            ...
            Method (WMMX, 3, NotSerialized)
            {
                ...
                If ((FUNC == 0x534F525F))
                {
                    If ((SizeOf (Arg2) >= 0x08))
                    {
                        ...
                        Return (\_SB.PC00.PEG0.PEGP._ROM (ARGS, XARG))
                    }
                }
